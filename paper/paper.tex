...
\begin{abstract}
This paper presents a new way of doing code reviews. Since they take up a lot of time and require
a great amount to coordination. We propose a new way doing reviews using the crowds. By 
integrating the \ide{}'s with the review platform we hope to make it easier for developers to review
